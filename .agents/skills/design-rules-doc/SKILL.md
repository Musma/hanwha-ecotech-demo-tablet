...
description: Create or update a project DESIGN.md from a Figma-exported PDF, Markdown design guide, or existing design token documentation, then connect it to AGENTS.md so future agents must follow the UI design and Vue component structure rules. Use when Codex needs to turn visual design guidelines into actionable frontend implementation rules for agents.
---
...
Also update `AGENTS.md` so future UI work must read `DESIGN.md` before creating or modifying screens.
...
5. Add or update a `AGENTS.md` section requiring agents to read `DESIGN.md` before UI work.
...
## AGENTS.md Connection

Add a concise design rules section to `AGENTS.md` if it is missing. Use or adapt the snippet in `references/agents-design-section.md`.
...
Do not duplicate the full `DESIGN.md` content inside `AGENTS.md`.
