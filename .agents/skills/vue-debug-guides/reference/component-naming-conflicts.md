...
import { Button as DesignButton } from "@acme/design-system";
import { Button as MarketingButton } from "@acme/marketing-ui";
</script>

<template>
  <DesignButton>Design System</DesignButton>
  <MarketingButton>Marketing UI</MarketingButton>
</template>
```
