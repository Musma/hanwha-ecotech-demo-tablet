...
description: Create and initialize a new Vue service project. Use when Claude Code needs to generate a real Vue boilerplate with Vite, Vue 3, TypeScript, Pinia, Vue Router, SCSS, axios, @musma/eslint-config-vue, and lint-staged, following this repository's CLAUDE.md and FOLDER_STRUCTURE.md conventions.
---
...
```bash
node .claude/skills/create-vue-service/scripts/create-vue-service.mjs <project-name>
```
