...
description: Install and configure shadcn-vue in an existing Vite Vue project. Use when Claude Code needs to add shadcn-vue to a project that already has Vue 3, Tailwind CSS v4, TypeScript, and @ alias support, while following FOLDER_STRUCTURE.md by placing UI components under shared/components/ui and utilities under shared/helpers.
---
...
```bash
node .claude/skills/setup-shadcn-vue/scripts/setup-shadcn-vue.mjs
```
